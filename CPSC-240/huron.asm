...
section .data
    ...
    side db "Please enter the length of a side: ", 0
	
    validmessage db 10, "The three sides are:  %.5lf   %.5lf   %.5lf", 10, 0
    invalidmessage db 10, "Invalid input was detected, please try again.", 10, 0
...
section .bss
    ...
    array: resq 3   ;will hold the side input              
...
;================================================================================================================================
    ...
    cmp r12, r13               ;check if loop has iterated 3 times
    jge validinput            ;if so, exit loop
    ...
    mov rdi, rsp               ;pass in previous input
    mov rax, 0
    call isfloat			   ;call isfloat to validate input

    cmp rax, 0                 ;if isflat returned false, jump to invalidinput
    je invalidinput
