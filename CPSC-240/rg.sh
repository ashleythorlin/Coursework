...
gcc -c -Wall -m64 -no-pie -o triangle.o triangle.c -std=c17 -g

#echo "Compile output_area.c"
gcc -c -Wall -m64 -no-pie -o output_area.o output_area.c -std=c17 -g

#echo "Compile output_error_message.c"
gcc -c -Wall -m64 -no-pie -o output_error_message.o output_error_message.c -std=c17 -g

#echo "Compile isfloat.cpp"
g++ -c -m64 -Wall -fno-pie -no-pie -o isfloat.o isfloat.cpp -std=c++17 -g

#echo "Link the object files"
gcc -m64 -no-pie -o a.out -std=c11 huron.o triangle.o output_area.o output_error_message.o isfloat.o -g
