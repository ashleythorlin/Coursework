...
template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countNodes(Node* node)
{
    if (node == nullptr)
        return 0;
...
template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::countLeaves(Node* node)
{
...
template <typename Key, typename Value>
int BinarySearchTree<Key, Value>::findMin(Node* node)
{
