...
template<typename Data_t>
size_t SLinkedList<Data_t>::freqR(Data_t element)
{
    Node* ptr = _head;
    return freqRHelper(ptr, element);
}

/*template<typename Data_t>
size_t SLinkedList<Data_t>::freqRHelper(Node* ptr, Data_t element, size_t total)
{
    size_t count = total;
    if (ptr == nullptr)
        return count;
    else
    {
        ...
        ptr->_next;
        return freqRHelper(ptr, element, count);
    }
...
template<typename Data_t>
size_t SLinkedList<Data_t>::freqRHelper(Node* ptr, Data_t element)
{
    size_t count = total;
    if (ptr == nullptr)
        return count;
    else
    {
        ...
        {
            ptr->_next;
            return freqRHelper(ptr, element) + 1;
        }
        ptr->_next;
        return freqRHelper(ptr, element);
    }
